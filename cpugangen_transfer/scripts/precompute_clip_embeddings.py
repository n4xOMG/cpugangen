...
def encode_prompt_sdxl(prompt, tokenizers, text_encoders, device="cuda"):
    ...
    with torch.no_grad():
        ...
        # Get the pooled output (last hidden state)
        # SDXL uses the penultimate layer for better quality
        pooled_1 = text_embeddings_1.hidden_states[-2]
        pooled_2 = text_embeddings_2.hidden_states[-2]
        ...
        return combined.squeeze(0).cpu().numpy()  # (77, 2048)
